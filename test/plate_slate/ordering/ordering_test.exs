defmodule PlateSlate.OrderingTest do
  ...
  describe "orders" do
    ...
    @valid_attrs %{customer_number: 42, items: %{}, ordered: "2010-04-17 14:00:00.000000Z", state: "some state"}
    @update_attrs %{customer_number: 43, items: %{}, ordered: "2011-05-18 15:01:01.000000Z", state: "some updated state"}
    @invalid_attrs %{customer_number: nil, items: nil, ordered: nil, state: nil}
    ...
    test "create_order/1 with valid data creates a order" do
      ...
      assert order.items == %{}
      assert order.ordered == DateTime.from_naive!(~N[2010-04-17 14:00:00.000000Z], "Etc/UTC")
    ...
    test "update_order/2 with valid data updates the order" do
      ...
      assert order.items == %{}
      assert order.ordered == DateTime.from_naive!(~N[2011-05-18 15:01:01.000000Z], "Etc/UTC")
